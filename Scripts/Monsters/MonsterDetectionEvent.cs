...
public class MonsterDetectionEvent : MonoBehaviour
{
    ...
    [SerializeField] bool circlePlayerDetection;
    [System.Serializable]
    ...
    [HideInInspector] public Vector3 _center;
    ...
    private void CheckPlayerDetection()
    {
        ...
        if (circlePlayerDetection)
        {
            hit = Physics2D.CircleCast(_center, playerDetectionDistance, Vector2.left, 0, LayerMask.GetMask("Player"));
        }
    ...
    private void OnDrawGizmos()
    {
        if (showDebug)
        {
            ...
            if(circlePlayerDetection)
                Gizmos.DrawWireSphere(_center, playerDetectionDistance);
            else
